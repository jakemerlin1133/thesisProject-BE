...
class AppUser(models.Model):
    ...
    guide_1 =  models.BooleanField(default=False)
    guide_2 =  models.BooleanField(default=False)
    guide_3 =  models.BooleanField(default=False)
    def __str__(self):
        return str(self.id)
...
class Store(models.Model):
    store = models.CharField(max_length=255, unique=True)
